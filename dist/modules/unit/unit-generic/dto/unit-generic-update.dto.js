...
class UnitGenericUpdateDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, unit: { required: true, type: () => require("../../unit/dto/unit-update.dto").UnitUpdateDto }, data1: { required: false, type: () => String }, data2: { required: false, type: () => String }, data3: { required: false, type: () => String }, data4: { required: false, type: () => String }, data5: { required: false, type: () => String } };
    }
}
__decorate([
