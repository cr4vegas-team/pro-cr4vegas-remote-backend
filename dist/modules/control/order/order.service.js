...
let OrderService = class OrderService {
    ...
    async insertOne(orderCreateDto) {
        ...
        const foundControl = (await this._controlService.findOneById(orderCreateDto.control)).control;
    ...
    async updateOne(orderUpdateDto) {
        ...
        const foundControl = (await this._controlService.findOneById(orderUpdateDto.control)).control;
